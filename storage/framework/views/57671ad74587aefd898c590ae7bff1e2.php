<?php if(auth()->check() && !auth()->user()->terms_accepted): ?>
        ...
        <div class="modal-content terms-modal">
            ...
            <div class="terms-body">
                <p class="terms-text">
                    ...
                    <a href="<?php echo e(route('supportandlegal')); ?>#terms-conditions" target="_blank">Terms & Conditions</a>
                    to continue using the platform.
                </p>

                <form method="POST" action="<?php echo e(route('accept.terms')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /home/1476201.cloudwaysapps.com/udhewsxxeh/public_html/resources/views/global/user-terms-accepted-form.blade.php ENDPATH**/ ?>