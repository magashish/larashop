                                    ...
                                    <div class="col-md-3">
                                        <div class="card h-100 bg-white border-0">
                                            <div class="card-body text-center">
                                                <div class="stat"><?php echo e($packageStats['total'] ?? 0); ?></div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card h-100 bg-white border-0">
                                            <div class="card-body text-center">
                                                ...
                                                <div class="stat"><?php echo e($packageStats['by_tier']['bronze'] ?? 0); ?></div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card h-100 bg-white border-0">
                                            <div class="card-body text-center">
                                                ...
                                                <div class="stat"><?php echo e($packageStats['by_tier']['silver'] ?? 0); ?></div>
                                                <div class="stat_description">Packages Sold</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card h-100 bg-white border-0">
                                            <div class="card-body text-center">
                                                ...
                                                <div class="stat"><?php echo e($packageStats['by_tier']['gold'] ?? 0); ?></div>
                                                <div class="stat_description">Packages Sold</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100 bg-white border-0">
                                            <div class="card-body text-center">
                                                ...
                                                <div class="stat"><?php echo e($pageEngagements['mazda'] ?? 0); ?></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100 bg-white border-0">
                                            <div class="card-body text-center">
                                                ...
                                                <div class="stat"><?php echo e($pageEngagements['grange_social'] ?? 0); ?></div>
                                                <div class="stat_description">Unique Users Engaged</div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1476201.cloudwaysapps.com/udhewsxxeh/public_html/resources/views/admin/stats-chart-dashboard.blade.php ENDPATH**/ ?>