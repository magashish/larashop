...
<section class="draws-section">
    <div class="draws-header">
        ...
        <div class="draws-controls">
            ...
            <span class="draws-count-badge">
                <?php echo e($total); ?> Draw<?php echo e($total !== 1 ? 's' : ''); ?>
    ...
    <div class="draws-slider" id="drawsSlider">
        ...
        <div class="draw-card-wrap">
            <div class="draw-card" data-date="<?php echo e(\Carbon\Carbon::parse($draw->draw_date)->toIso8601String()); ?>">
                <div class="draw-card-type"><?php echo e(strtoupper($draw->draw_type)); ?></div>
                <div class="draw-card-title"><?php echo e($draw->title); ?></div>
                <div class="draw-card-desc"><?php echo e($draw->prize_description); ?></div>
                <div class="draw-countdown"></div>
                <div class="draw-card-footer">
                    <span class="draw-prize-badge">
                        <?php if($draw->prize_type === 'cash'): ?>
                            $<?php echo e(number_format($draw->cash_amount, 0)); ?> Cash
                        <?php else: ?>
                            <?php echo e($draw->prize_title); ?>

                        <?php endif; ?>
                    </span>
                    <span class="draw-card-date">
                        <?php echo e(\Carbon\Carbon::parse($draw->draw_date)->format('j M Y \a\t h:i a')); ?>
...
<?php endif; ?><?php /**PATH /home/1476201.cloudwaysapps.com/udhewsxxeh/public_html/resources/views/global/upcoming-draws-carousel.blade.php ENDPATH**/ ?>