...
<head>
    ...
    <!-- Scripts -->
    @vite(['resources/sass/app.scss',  'resources/css/slick.css', 'resources/css/custom.css', 'resources/js/app.js'])
</head>
<body>
...
<script src="{{ asset('assets/js/TweenMaxAnimation.js') }}"></script>
