    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header fw-bold">{{ __('Create New Product Package') }}</div>
                    ...
                    <form action="{{ route('product-packages.store') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="name" name="name" type="text"
                                ...
                                value="{{ old('name') }}" placeholder="Enter product package name" required>
                            @error('name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="price" name="price" type="number" step="0.01"
                                ...
                                value="{{ old('price') }}" placeholder="Enter price" required min="0.01">
                            @error('price')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="entries_into_draw" name="entries_into_draw" type="number"
                                ...
                                value="{{ old('entries_into_draw') }}" placeholder="Enter number of entries" required min="1">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="access_duration_weeks" name="access_duration_weeks" type="number"
                                ...
                                value="{{ old('access_duration_weeks') }}" placeholder="Enter access duration in weeks" required min="1">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="description" name="description"
                                ...
                                rows="5" placeholder="Enter description for the package">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-plus-circle"></i> Create Product Package
                            </button>
                        </div>
                    </form>
                </div>
