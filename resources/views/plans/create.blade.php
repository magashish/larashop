    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header fw-bold">{{ __('Subscription Plans / Create') }}</div>
                <div class="card-body">
                    ...
                    <form action="{{ route('plans.store') }}" method="POST">
                        ...
                        <div id="subscription-fields" style="display:none;">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('stripe_plan') is-invalid @enderror" id="stripe_plan" name="stripe_plan" value="{{ old('stripe_plan') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('paypal_plan_id') is-invalid @enderror" id="paypal_plan_id" name="paypal_plan_id" value="{{ old('paypal_plan_id') }}" required>
                        ...
                        <div id="package-fields" style="display:none;">
                            {{-- <div class="mb-3">
                                ...
                                value="{{ old('entries_into_draw') }}" placeholder="Enter number of entries" min="1">
                            ...
                            <div class="mb-3">
                                ...
                                value="{{ old('access_duration_weeks') }}" placeholder="Enter access duration in weeks" min="1">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('price_description') is-invalid @enderror" id="price_description" name="price_description" value="{{ old('price_description') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('small_description') is-invalid @enderror" id="small_description" name="small_description" rows="3">{{ old('small_description') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('read_more') is-invalid @enderror" id="read_more" name="read_more" rows="3">{{ old('read_more') }}</textarea>
                            @error('read_more')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('sub_description') is-invalid @enderror" id="sub_description" name="sub_description" rows="3">{{ old('sub_description') }}</textarea>
