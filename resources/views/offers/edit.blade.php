    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header fw-bold">{{ __('Edit: ' . $offer->title) }}</div>
                <div class="card-body">
                     @if (session('status'))
                    ...
                    <form action="{{ route('offers.update', $offer->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="category_ids" class="form-label fw-semibold">Offer Category<span class="text-danger">*</span></label>
                            <select class="form-control categories_select2 @error('category_ids') is-invalid @enderror" id="category_ids" name="category_ids[]" multiple="multiple" required>
                        ...
                        <div class="mb-3">
                            <label for="terms_conditions" class="form-label fw-semibold">Terms & Conditions <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text">
                                    <a href="{{ route('organisations.create')}}" class="btn btn-primary btn-sm" target="_blank">
                    ...
                    {{-- <div class="mb-3">
                        <label for="full_address" class="form-label fw-semibold">Full Address <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('full_address') is-invalid @enderror" id="full_address" name="full_address" value="{{ old('full_address', $offer->full_address) }}" required readonly>
                        @error('full_address')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div> --}}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control datepicker @error('start_date') is-invalid @enderror" id="start_date" name="start_date" value="{{ old('start_date', $offer->start_date?->format('Y-m-d')) }}">
                        @error('start_date')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="processing_status" class="form-label fw-semibold">Processing Status <span class="text-danger">*</span></label>
                        <select class="form-select @error('processing_status') is-invalid @enderror" id="processing_status" name="processing_status" required>
                            @foreach ($organisationStatuses as $value => $label)
                            <option value="{{ $value }}" {{ old('processing_status', $offer->processing_status) == $value ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                            @endforeach
                        </select>
