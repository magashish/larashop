...
<section class="image-banner-sec pb-0">
	<div class="container">
		<div class="inner-content">
			<img src="images/Screenshot-2025-06-26-120836.png" alt="Banner Image">
		</div>
		<div class="bg-title">
			<div class="yellow-bg text-uppercase">WHAT'S ON</div>
			<div class="black-bg text-uppercase">WHAT'S ON</div>
		</div>
	</div>
</section>

<section class="packages-quote-sec pt-0">
	<div class="container ">
		<div class="row">
			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active" id="nav-one" role="tabpanel" aria-labelledby="nav-one-tab" tabindex="0">
					<div id="cash-events-container">
						...
						<p>No cash available for Charity.</p>
						@else
						@include('business.events.partials.events-list', ['events' => $cash_events,'event_category' => 1])
						@endif
					</div>
					@if ($cash_hasMore)
					...
					<div class="tab-pane fade" id="nav-two" role="tabpanel" aria-labelledby="nav-two-tab" tabindex="0">
						...
						<div id="prize-events-container">
							...
							<p>No prize available for Charity.</p>
							@else
							@include('business.events.partials.events-list', ['events' => $prize_events,'event_category' => 2])
							@endif
						</div>
						@if ($prize_hasMore)
						<div class="action-btn text-center">
						...
						<div class="tab-pane fade" id="nav-three" role="tabpanel" aria-labelledby="nav-three-tab" tabindex="0">
							<div id="charity-events-container">
								...
								<p>No events available for Charity.</p>
								@else
								@include('business.events.partials.events-list', ['events' => $charity_events,'event_category' => 3])
								@endif
					...
					<div class="row align-items-center">
						...
						<div class="col-12">
							<div class="social-slider">
								...
								<img src="images/social4.png">
								<img src="images/social5.png">
			...
			<script>
				$(document).ready(function() {
					...
					$('.load-more').on('click', function() {
						...
						$.ajax({
							url: '{{ route('consumer.events.index') }}', 
							method: 'GET',
							headers: {
