{{-- 
    Upsell Modal — YES, PROCEED button
    Popup se click hone pe upsell initiate route pe POST karo
    Session set hogi aur checkout page pe redirect hoga
--}}
                ...
                <div class="row mx-0">
                    ...
                    <div class="col-sm-6 px-0">
                        <div class="content-wrapper position-relative text-center h-100">
                            ...
                            {{-- YES PROCEED — upsell initiate route --}}
                            <form action="{{ route('upsell.initiate', ['plan' => $package_plan->id]) }}" method="POST">
                                @csrf
                            ...
                            <button type="button" class="btn btn-secondary text-uppercase w-100 mt-sm-3 mt-2"
