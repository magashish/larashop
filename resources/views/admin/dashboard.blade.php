                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ get_total_user_count(); }}</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ getDailyActiveConsumers(); }}</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ getPayingSubscribers(); }}</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ getInactiveSubscribersCount(); }}</div>
                            ...
                            <div class="p-3 h-100 bg-default rounded shadow-sm">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ get_total_organisations_count(); }}</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ get_total_offer_count(); }}</div>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ $organisations['new'] }}</div>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ $organisations['approved'] }}</div>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ $organisations['rejected'] }}</div>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ $offer['expired'] }}</div>
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <div class="stat">{{ $offer['rejected'] }}</div>
                                                <div class="stat_description">Rejected</div>
                                            </div>
                                        </div>
                                    </div>
