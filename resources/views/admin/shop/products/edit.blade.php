                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="care_instructions" class="form-control" rows="4" placeholder="e.g. Machine wash cold. Do not bleach. Tumble dry low.">{{ old('care_instructions', ($product->meta ?? [])['care_instructions'] ?? '') }}</textarea>
