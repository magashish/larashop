        ...
        <div class="col-md-4">
            <div class="card shadow mb-3">
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" name="is_active" value="1" form="productForm" id="is_active" @checked(old('is_active', $product->is_active))>
                        <label class="form-check-label" for="is_active">Active (visible in shop)</label>
                    </div>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="is_featured" value="1" form="productForm" id="is_featured" @checked(old('is_featured', $product->is_featured))>
            ...
            <div class="card shadow mb-3">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <input type="file" name="featured_image" class="form-control" accept="image/*" form="productForm">
                </div>
            </div>
                    ...
                    @if($product->images->count())
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-4 position-relative">
                                ...
                                <form action="{{ route('admin.shop.products.delete-image', $image) }}" method="POST" class="position-absolute top-0 end-0 m-1">
                                    @csrf @method('DELETE')
                                    <button class="btn btn-danger btn-sm p-0 px-1" onclick="return confirm('Remove image?')">×</button>
                                </form>
                            </div>
                            @endforeach
                        </div>
