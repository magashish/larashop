@extends('layouts.xhale_mail') {{-- <-- CHANGED HERE --}}

@section('title', 'Xhale Admin Password Reset') {{-- Specific title for this email --}}
@section('header_title', 'Password Reset') {{-- Text for the header line --}}
